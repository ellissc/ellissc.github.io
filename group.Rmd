...
<img src="img/logo.svg" alt="DAT Group logo" style="width: 100%; height: auto;">

  </div>
  <div class="dat-title" style="flex: 1; min-width: 200px;">

# Development Across Timescales (DAT) Research Group
...
In the DAT research group, we use interdisciplinary approaches to understand development across multiple timescales, from in-the-moment adaptations in conversation, to language learning across the lifespan, and to cross-generational developments across generations.
